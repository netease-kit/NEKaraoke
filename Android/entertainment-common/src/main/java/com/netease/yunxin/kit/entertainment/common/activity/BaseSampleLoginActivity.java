...
public abstract class BaseSampleLoginActivity extends BasePartyActivity {
  ...
  protected View getRootView() {
    ...
    binding.login.setOnClickListener(v -> createAccountThenLogin(getVersionCode()));
  ...
  private void createAccountThenLogin(String versionCode) {
  ...
  private void createAccount(String versionCode, Callback<ECModelResponse<NemoAccount>> callback) {
