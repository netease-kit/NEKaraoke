...
import com.netease.yunxin.app.newlive.gift.GiftInfo
...
object GiftCache {
    ...
    init {
        ...
        TOTAL_GIFT.append(
            ...
            GiftInfo(
                1,
                Utils.getApp().getString(R.string.karaoke_glow_stick),
                9,
        ...
        TOTAL_GIFT.append(
            ...
            GiftInfo(
                2,
                Utils.getApp().getString(R.string.karaoke_arrange),
                99,
        ...
        TOTAL_GIFT.append(
            ...
            GiftInfo(
                3,
                Utils.getApp().getString(R.string.karaoke_sports_car),
                199,
        ...
        TOTAL_GIFT.append(
            ...
            GiftInfo(
                4,
                Utils.getApp().getString(R.string.karaoke_rockets),
                999,
