...
/** 待点歌曲 */
public class KaraokeOrderSongModel {
  ...
  public KaraokeOrderSongModel(NECopyrightedSong song) {
  ...
  public boolean equals(Object o) {
    ...
    KaraokeOrderSongModel that = (KaraokeOrderSongModel) o;
