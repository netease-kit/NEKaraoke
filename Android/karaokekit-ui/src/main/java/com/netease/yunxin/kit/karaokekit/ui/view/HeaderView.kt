...
class HeaderView : LinearLayout, RefreshHeader {
    ...
    override fun onStateChanged(
        ...
        when (newState) {
            RefreshState.None, RefreshState.PullDownToRefresh -> tvHeaderText?.setText(R.string.karaoke_pull_to_refresh)
            RefreshState.Refreshing -> tvHeaderText?.setText(R.string.karaoke_refreshing)
            RefreshState.ReleaseToRefresh -> tvHeaderText?.setText(R.string.karaoke_release_to_refresh)
            else -> {}
        }
    }
}
