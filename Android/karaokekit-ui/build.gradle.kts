...
dependencies {
    ...
    implementation("com.netease.yunxin.kit.karaoke:karaokekit:1.4.0")
    ...
    implementation("com.netease.yunxin.kit.karaoke:karaokekit-pitch-ui:1.4.0")
    implementation("com.netease.yunxin.kit.karaoke:karaokekit-lyric-ui:1.4.0")
    api("com.netease.yunxin.kit.karaoke:karaokekit-audioeffect:1.4.0")
    api("com.netease.yunxin.kit.karaoke:karaokekit-audioeffect-ui:1.4.0")
