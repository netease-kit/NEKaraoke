...
- (NEKaraokeChooseView *)chooseView {
  if (!_chooseView) {
    ...
    @weakify(self) _chooseView.chooseSong = ^{
      @strongify(self) if ([self.delegate respondsToSelector:@selector(onLyricAction:)]) {
...
- (void)setWaitUserIcon:(UIImage *)waitUserIcon {
...
- (NEKaraokeMatchView *)matchView {
  if (!_matchView) {
    ...
    @weakify(self) _matchView.toSolo = ^{
      @strongify(self) if ([self.delegate respondsToSelector:@selector(onLyricAction:)]) {
        dispatch_async(dispatch_get_main_queue(), ^{
...
- (void)setMatchUserIcon:(UIImage *)matchUserIcon {
...
- (void)setChorusMainUserIcon:(UIImage *)chorusMainUserIcon {
...
- (void)setChorusAttachUserIcon:(UIImage *)chorusAttachUserIcon {
...
- (void)setNoLyricUserIcon:(UIImage *)noLyricUserIcon {
