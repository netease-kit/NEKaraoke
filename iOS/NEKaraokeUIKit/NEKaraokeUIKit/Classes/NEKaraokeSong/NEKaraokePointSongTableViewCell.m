...
@interface NEKaraokePointSongTableViewCell ()

@end

@implementation NEKaraokePointSongTableViewCell
...
- (void)initView {
  ...
  self.songLabel.textColor = [UIColor karaoke_colorWithHex:color_FFFFFF];
  ...
  self.anchorLabel.textColor = [UIColor karaoke_colorWithHex:color_FFFFFF alpha:0.6];
  ...
  self.downloadingLabel.textColor = [UIColor karaoke_colorWithHex:color_FFFFFF];
  ...
  self.statueBottomLabel.backgroundColor = [UIColor karaoke_colorWithHex:color_FFFFFF alpha:0.8];
  ...
  self.statueTopLabel.backgroundColor = [UIColor karaoke_colorWithHex:color_FE7081];
