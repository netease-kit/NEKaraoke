...
- (void)karaoke_onPreloadComplete:(NSString *)songId
  ...
  @synchronized(self) {
    ...
    NEKaraokeOrderSongParams *orderSong = [NEKaraokeOrderSongParams new];
