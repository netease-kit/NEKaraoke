...
@property(nonatomic, copy) NSString *waitUserIcon;

- (void)updateWaitTime:(NSInteger)time;

#pragma mark - 合唱匹配页面
@property(nonatomic, copy) NSString *matchUserIcon;
...
@property(nonatomic, copy) NSString *chorusMainUserIcon;
@property(nonatomic, copy) NSString *chorusAttachUserName;
@property(nonatomic, copy) NSString *chorusAttachUserIcon;
...
@property(nonatomic, copy) NSString *noLyricUserIcon;
