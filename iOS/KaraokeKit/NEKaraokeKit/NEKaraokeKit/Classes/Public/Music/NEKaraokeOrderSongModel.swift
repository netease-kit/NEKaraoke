...
public class NEKaraokeOrderSongModel: NSObject, Codable {
  ...
  // 下一首歌曲
  public var nextOrderSong: NEKaraokeOrderSongResult?
  // 附带消息
...
@objcMembers
public class NEKaraokeOrderSongSongModel: NSObject, Codable {
  /// 点歌编号
...
@objcMembers
public class NEKaraokeOrderSongOperatorUser: NSObject, Codable {
